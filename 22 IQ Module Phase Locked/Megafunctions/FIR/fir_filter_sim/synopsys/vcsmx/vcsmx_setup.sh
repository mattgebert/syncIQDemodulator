...
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/matt-g/altera/13.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/fir_filter_rtl.vhd"                             
  vhdlan -xlrm "$QSYS_SIMDIR/fir_filter_ast.vhd"                             
  vhdlan -xlrm "$QSYS_SIMDIR/fir_filter.vhd"                                 
  vhdlan -xlrm "$QSYS_SIMDIR/fir_filter_tb.vhd"                              
fi
