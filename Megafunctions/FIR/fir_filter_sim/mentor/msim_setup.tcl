...
# ACDS 13.1 162 linux 2017.10.11.15:35:33
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/matt-g/altera/13.1/quartus/"
}
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/fir_filter_rtl.vhd"                             
  vcom "$QSYS_SIMDIR/fir_filter_ast.vhd"                             
  vcom "$QSYS_SIMDIR/fir_filter.vhd"                                 
  vcom "$QSYS_SIMDIR/fir_filter_tb.vhd"                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
