...
if {[file exists fir_filter_coef_reload.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE fir_filter_coef_reload.txt -section_id tb -library work
}
if {[file exists fir_filter_coef_reload_rtl.txt]} {
  set_global_assignment -name EDA_TEST_BENCH_FILE fir_filter_coef_reload_rtl.txt -section_id tb -library work
}
set_global_assignment -name EDA_TEST_BENCH_FILE fir_filter_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE fir_filter_tb.vhd -section_id tb -library work
