...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/fir_filter_rtl.vhd"                             
  ncvhdl -v93 "$QSYS_SIMDIR/fir_filter_ast.vhd"                             
  ncvhdl -v93 "$QSYS_SIMDIR/fir_filter.vhd"                                 
  ncvhdl -v93 "$QSYS_SIMDIR/fir_filter_tb.vhd"                              
fi
