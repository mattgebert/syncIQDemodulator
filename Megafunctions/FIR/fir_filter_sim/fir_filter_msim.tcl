...
set quartus_rootdir /home/matt-g/altera/13.1/quartus/
...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists fir_filter.vhd]} {vcom -93 -work work fir_filter.vhd}
    if {[file exists fir_filter.v]} {vlog -work work fir_filter.v}
    vcom -93 -work work fir_filter_ast.vhd
    vcom -93 -work work fir_filter_rtl.vhd
